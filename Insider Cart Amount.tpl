...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Insider Cart Amount",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "This template gets total cart amount from dataLayer. You should specify the variable. It interprets dots as nested values. For example, \"a.b.c\" as three nested levels: {a: {b: {c: \"value\"}}}.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "cartAmount",
    "displayName": "Cart Amount Variable",
...
Created on 8/11/2020, 4:28:51 PM
